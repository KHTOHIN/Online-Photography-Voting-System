...
<?php
	...
	if(isset($_POST['submit']))
	{
		...
		{
			$s="select id,type from user where Email='$email'";
...
<body class="login-page sidebar-collapse">
    ...
    <div class="page-header" filter-color="orange">
        <div class="page-header-image" style="background-image:url(img/login01.jpg)"></div>
        <div class="container">
                ...
                <div class="card card-login card-plain">
                    <form class="form" method="POST" action="">
                        ...
                        <div class="footer text-center" style="padding-top: 0px;">
							<input class="btn btn-primary btn-round" type="submit" name='submit' style="padding-left: 100px;padding-right: 100px;" value="Login">
						</div>
                        <div class="pull-left">
                            <h6>
