        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navigation" data-nav-image="./assets/img/blurred-image-1.jpg">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="showcontest.php">
				...
				<ul class="navbar-nav">
					<li class="nav-item dropdown">
						<a href="#" class="nav-link dropdown-toggle" id="navbarDropdownMenuLink" data-toggle="dropdown">
							<i aria-hidden="true"><img src="<?php echo 'data:image/jpeg;base64,'.base64_encode( $result['Profilepic'] );?>" alt="pic" class="rounded-circle" height="25" width="25"></i>
						</a>
        ...
        <div class="page-header clear-filter" filter-color="orange">
            ...
            <div class="container">
                <div class="content-center brand">
                    ...
                    <h1 class="h1-seo">Nameless</h1>
                    <h3>Online Photography Voting System</h3>
                </div>
